...
/**
* \brief Busca todos los números impares de un array de números enteros y los reemplaza por 0
* \param int* cadena: Cadena que va a ser objetivo de la función
* \param int limite: Define el tamaño de la cadena
* \return Retorna 0 (EXITO) si se transformaron todos los números impares de la cadena a ceros y -1 (ERROR) si no*/
int borrarImpares(int* cadena, int limite)
{
	int retorno = -1;
...
/**
* \brief Ordena un array de menor a mayor con el método de selección
* \param int* array: Cadena que va a ser ordenada
* \param limite: Define el tamaño de la cadena
* \return Retorna 0 (EXITO) si la cadena se ordenó correctamente y -1 (ERROR) si no*/
int ordenSeleccion(int* array, int limite)
{
	int retorno = -1;
	int masChico;
	int auxiliar;
